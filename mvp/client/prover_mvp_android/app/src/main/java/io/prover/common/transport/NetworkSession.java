...
public class NetworkSession {
    ...
    public NetworkSession(HelloResponce hello, ECKey key) {
        ...
        Log.d(NetworkRequest.TAG, String.format("new netSession; nonce: %s, this: %s", actualNonce.toString(), this));
    }
    ...
    public void onNewHelloResponce(HelloResponce hello) {
        ...
        Log.d(NetworkRequest.TAG, String.format("update session hello, oldNonce: %s, newNonce: %s, selected: %s, this: %s",
    ...
    public void increaseNonce() {
        ...
        Log.d(NetworkRequest.TAG, String.format("new nonce: %s, this: %s", actualNonce.toString(), this));
    }
}