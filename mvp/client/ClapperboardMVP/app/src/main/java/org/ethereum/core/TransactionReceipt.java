...
import org.ethereum.util.LogInfo;
...
import static org.ethereum.util.Utils.nullToEmpty;
...
public class TransactionReceipt {
    ...
    public TransactionReceipt(byte[] rlp) {
        ...
        if (receipt.size() > 6) {
            ...
            error = errBytes != null ? new String(errBytes, UTF_8) : "";
        }
    ...
    public byte[] getEncoded(boolean receiptTrie) {
        ...
        return receiptTrie ?
                ...
                RLP.encodeList(postTxStateRLP, cumulativeGasRLP, bloomRLP, logInfoListRLP,
                        ...
                        RLP.encodeElement(error.getBytes(UTF_8)));
