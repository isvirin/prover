...
import io.prover.clapperboardmvp.transport.responce.FixableEtheriumException;
import io.prover.clapperboardmvp.transport.responce.KnownTransactionException;
import io.prover.clapperboardmvp.transport.responce.LowFundsException;
import io.prover.clapperboardmvp.transport.responce.NonceTooLowException;
...
public abstract class TransactionNetworkRequest<T> extends NetworkRequest<T> {
    ...
    protected static final int GAS_LIMIT = 1_000_000;
