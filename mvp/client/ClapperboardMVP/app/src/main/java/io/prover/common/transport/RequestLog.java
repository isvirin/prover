...
public class RequestLog {
    ...
    public void onStart(HttpURLConnection urlConnection) {
        if (storeDebug) {
            ...
            Log.d(NetworkRequest.TAG, "sending request" + toString());
        }
    ...
    public void log() {
        if (exception == null) {
            Log.d(NetworkRequest.TAG, toString());
        } else {
            Log.e(NetworkRequest.TAG, toString());
            Log.e(NetworkRequest.TAG, exception.getMessage(), exception);
        }
    }
